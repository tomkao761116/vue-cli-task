    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-sm-10 align-self-center">
        <ul class="step-progressbar py-3">
          <li class="step-progressbar__item step-progressbar__item--complete"><small>確認購物車</small></li>
          <li class="step-progressbar__item step-progressbar__item--active"><small>填寫資料</small></li>
