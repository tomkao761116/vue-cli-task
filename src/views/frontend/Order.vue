          ...
          <div class="col-sm-10 align-self-center">
            ...
            <validation-observer v-slot = "{invalid}" >
              <form @submit.prevent="createOrder" class="text-left">
                <div class="row">
                  <!-- 填寫訂購資訊 -->
                  <div class="purchaseInfo col-md-6 align-self-start">
                  ...
                  <div class="orderInfo col-sm-6 align-self-start">
                        ...
                        <table class="table text-right">
                          <tbody>
                            <tr>
                                ...
                                <td scoped="col" class="border-top-0">NT{{ orignalTotal | currency }}</td>
                            </tr>
                            <tr>
