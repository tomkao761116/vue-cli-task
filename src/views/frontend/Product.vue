          ...
          <div class="container">
            <div class="row d-flex justify-content-start align-items-center">
              <div class="productImage col-sm-6">
                <img class="bd-placeholder-img" width="80%" height="500px" :src="product.imageUrl[0]"
                    alt="商品圖片">
              </div>
              <div class="productInfo col-sm-6 pt-2 pl-5 pr-5 text-left">
                ...
                <form class="buyFunction">
                  <div class="form-group row d-flex align-items-end">
                    <label for="quantity" class="col-sm-2 col-form-label text-muted mt-2 mb-2">數量</label>
                    ...
                    <div class="col-sm-5 text-center mt-2 mb-2">
                      <button type="button" class="addToCart btn btn-primary" :disabled=" status.loadingItem === product.id"
            ...
            <hr>
            <div id="productDescription" class="row d-flex justify-content-start align-items-center">
              <div class="col-sm-12  mt-4 mb-4">
                <div class="form-group row text-left">
                  <label for="content" class="col-sm-3 col-form-label text-muted"><strong>商品描述</strong></label>
                ...
                <div class="form-group row text-left">
                  <label for="precautions" class="col-sm-3 col-form-label text-muted"><strong>商品注意事項</strong></label>
                ...
                <div class="form-group row text-left">
                  <label for="precautions" class="col-sm-3 col-form-label text-muted"><strong>盆栽照顧小叮嚀</strong></label>
                  <div id="precautions" class="col-sm-9 ">
                    <p>
                    ...
                    <p>
                      3.如果發現有葉子突然發黑或變黃，這可能是過度澆水造成的，請調整水量
                    </p>
                    <p>
            ...
            <hr>
            <div id="relatedProducts" class="row d-flex justify-content-start align-items-center">
              <div class="col-sm-12">
                <div class="row text-left">
                  <div class="col-sm-12">
                    <p class="text-muted"><strong>其他款式</strong></p>
                    <relatedProducts
                      :product="product"
                      @update="getProduct" />
                  </div>
