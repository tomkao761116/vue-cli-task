    ...
    <main role="main">
      <div class="row d-flex justify-content-start align-items-center">
        ...
        <div class="productInfo col-md-6 pt-2 pl-5 pr-5 text-left">
          <div class="productTitle mb-3">
            <h1 class="h4 font-weight-bold">{{ product.title }}</h1>
          </div>
          <div class="productContent mt-3 mb-4">
            <p>{{ product.description }}</p>
          </div>
          <div class="productPrice text-right p-2">
            <span  v-if="product.origin_price !== 0" class="orignal-price text-muted mr-2">
              NT{{ product.origin_price | currency }}
              </span>
              <span class="h4 activity-price">
      ...
      <div class="productDescription row d-flex justify-content-start align-items-center">
        <div class="col-sm-12 mt-4 mb-4 pl-4">
          ...
          <div class="form-group row text-left">
            <h2 for="notice" class="h5 col-sm-3 col-form-label text-muted"><strong>商品注意事項</strong></h2>
          ...
          <div class="form-group row text-left">
            <h2 for="precautions" class="h5 col-sm-3 col-form-label text-muted"><strong>盆栽照顧小叮嚀</strong></h2>
      ...
      <div class="relatedProducts row d-flex justify-content-start align-items-center">
        <div class="col-sm-12">
          <div class="row text-left">
            <div class="col-sm-12">
              <h3 class="h5 text-muted mb-4"><strong>其他款式</strong></h3>
              <relatedProducts
                :product="product"
                @update="getProduct" />
            </div>
